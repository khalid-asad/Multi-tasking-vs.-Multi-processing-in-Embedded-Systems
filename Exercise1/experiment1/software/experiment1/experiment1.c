...
extern OS_EVENT *MboxFind0Start;
extern OS_EVENT *MboxFind1Start;
extern OS_EVENT *MboxFind0Done;
extern OS_EVENT *MboxFind1Done;
extern OS_EVENT *MboxGenArrayStart[2];
extern OS_EVENT *MboxFindMinMax;
extern OS_EVENT *MboxFind1Median;
...
int init_OS_data_structs(void)
{
	...
	for (i = 0; i < 2; i++) {
		MboxFind0Start = OSMboxCreate((void *)0);
		MboxFind1Start = OSMboxCreate((void *)0);


		MboxFind0Done = OSMboxCreate((void *)0);
		MboxFind1Done = OSMboxCreate((void *)0);
